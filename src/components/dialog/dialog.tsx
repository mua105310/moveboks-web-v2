...
export default function Dialog() {
    ...
    return (
        ...
        <div className={`fixed bottom-0 lg:hidden bg-[var(--background)] w-full flex justify-center border-t border-white/40 rounded-t-[50px] transition-all duration-300 ${isOpen ? 'z-[10000] h-[80vh]' : 'z-[10000] h-[5vh]'}`}>
